(function ($) {
  ...
  Backdrop.form_placeholder = {};

  Backdrop.form_placeholder.elementIsSupported = function ($element) {
  ...
  Backdrop.form_placeholder.placeholderIsSupported = function () {
  ...
  Backdrop.behaviors.form_placeholder = {
    attach: function (context, settings) {
      // In some cases settings after ajax form submit could contain only
      // settings from response but not all Backdrop.settings data.
      ...
      $(include).not(exclude).each(function () {
        var $textfield = $(this);
        var elementSupported = Backdrop.form_placeholder.elementIsSupported($textfield);
        var placeholderSupported = Backdrop.form_placeholder.placeholderIsSupported();
        ...
        // Placeholder is supported.
          ...
          if (required_indicator === 'append') {
            ...
            $label.find('.form-required').text('(' + Backdrop.t('required') + ')');
          }
